...
public class C extends LKApiBusGetListController<I, O, SysEquipmentLocationEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysEquipmentLocationEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
