...
public class C extends LKApiBusGetListController<I, O, SysCameraEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysCameraEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
