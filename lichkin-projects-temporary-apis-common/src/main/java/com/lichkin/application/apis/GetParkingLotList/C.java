...
public class C extends LKApiBusGetListController<I, O, SysParkingLotEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysParkingLotEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
